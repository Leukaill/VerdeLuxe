...
- Passionate advocate for sustainable gardening practices`,
    ...
    if (existingNewsletter.empty) {
      ...
      console.log('Newsletter subscribers already exist in Firestore (' + existingNewsletter.size + ' found)');
    }
    ...
    if (existingAdmins.empty) {
      ...
      console.log('Admin credentials already exist in Firestore (' + existingAdmins.size + ' found)');
    }
